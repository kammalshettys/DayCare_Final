...
public class TeacherController {
    ...
    public void addClassRoom(Student student){
        ...
        Optional<ClassRoom> cl = School.classrooms.stream().filter(e->e.getTeacherStudentGroup().containsKey(teacher)).findAny();
        ...
        List<Student> std = classRoom.getTeacherStudentGroup().get(teacher);
        std.add(student);
